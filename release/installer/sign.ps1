...
.DESCRIPTION
    ...
    1. -GenerateCert
         ...
         Outputs:
           release\installer\certs\fastflowprompt.pfx   (private — keep secret)
           release\installer\certs\fastflowprompt.cer   (public — ship with installer)
...
.PARAMETER PfxPath
    Override the default .pfx location. Default: release\installer\certs\fastflowprompt.pfx
...
.EXAMPLE
    ...
    .\sign.ps1 -FilePath ..\out\Flowkey-Setup-1.5.0.exe
#>
